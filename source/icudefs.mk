...
prefix = /home/auxten/libicu/icu/source/../libicu
exec_prefix = ${prefix}
...
CFLAGS = -O3 -fPIC -std=c11 -Wall -pedantic -Wshadow -Wpointer-arith -Wmissing-prototypes -Wwrite-strings $(THREADSCFLAGS) -Qunused-arguments -Wno-parentheses-equality
# CXXFLAGS is for C++ only flags
CXXFLAGS = -O3 -fPIC -W -Wall -pedantic -Wpointer-arith -Wwrite-strings -Wno-long-long -std=c++11 $(THREADSCXXFLAGS) -Qunused-arguments -Wno-parentheses-equality
...
ICULEHB_CFLAGS=-I/usr/include/icu-le-hb -I/usr/include/harfbuzz -I/usr/include/glib-2.0 -I/usr/lib/x86_64-linux-gnu/glib-2.0/include
